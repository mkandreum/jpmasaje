...
export default function App() {
  ...
  return (
    <div className="w-full h-[100dvh] bg-[#0E1410] flex flex-col items-center sm:p-6 font-sans text-[#F9F8F6] overflow-hidden">
      <Toaster position="top-center" richColors />
      <div className="w-full max-w-md h-full sm:h-[850px] sm:max-h-[96vh] bg-[#141A16] sm:rounded-[40px] shadow-2xl overflow-hidden flex flex-col relative ring-1 ring-white/5">
